...
def generate_tryon(face_image_path, clothing_image_path, prompt, out_path=None):
    ...
    clothing_part = _part_from_image_path(clothing_image_path)

    user_text = prompt or (
        "Composite the person to be wearing the provided clothing item. "
        "Keep identity, facial features, body proportions, and lighting consistent. "
        "Produce a photorealistic image."
    )

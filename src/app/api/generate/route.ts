...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const coverImage = "https://www.deanna2u.com/img/Logo_H_blanco.png";
    const thumbnailImage = "https://www.deanna2u.com/img/Logo_H_blanco.png";
    ...
    const clippingData: ClippingData = {
      ...
      thumbnail: generatedImage.inlineData?.data ? `data:${generatedImage.inlineData.mimeType};base64,${generatedImage.inlineData.data}` : "https://www.gstatic.com/lamda/images/gemini_aurora_thumbnail_4g_e74822ff0ca4259beb718.png",
      useThumbnail: 1,
      type: 1,
      url: generatedImage.inlineData?.data ? `data:${generatedImage.inlineData.mimeType};base64,${generatedImage.inlineData.data}` : "https://www.gstatic.com/lamda/images/gemini_aurora_thumbnail_4g_e74822ff0ca4259beb718.png",
